...
class OrderController extends Controller
{
    ...
    public function add_new_orders(Request $request)
    {
        $category = Category::all();
        return view('backend.sales.create', compact('category'));
    }
    ...
    public function getProduct(Request $request) 
    {
        ...
        foreach ($product as $product_item) {
            $html .= '<option value="' . $product_item->id . '" data-qty="'. $product_item->min_qty .'">' . $product_item->name . '</option>';
        }
