                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" class="form-control mb-3 {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $customer->name }}" placeholder="{{  translate('Full Name') }}" name="name">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="email" class="form-control mb-3 {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ $customer->email }}" placeholder="{{  translate('Email') }}" name="email">
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <div class="card-body">
                        <div class="p-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control mb-3 {{ $errors->has('address') ? ' is-invalid' : '' }}" value="" placeholder="{{ translate('Your Address')}}" rows="2" name="address">{{ $address->address }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control mb-3 {{ $errors->has('postal_code') ? ' is-invalid' : '' }}" placeholder="{{ translate('Your Postal Code')}}" name="postal_code" value="{{ $address->postal_code }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control mb-3 {{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ translate('+880')}}" name="phone" value="{{ $address->phone }}">
                                    @if ($errors->has('phone'))
                                        <span class="invalid-feedback" role="alert">
